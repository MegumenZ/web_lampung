  ...
  return (
    <PageWithSidebar>
      ...
      >
        ...
        {/* Tabel Data IPKD 2023 */}
        <div className="overflow-x-auto">
          <table className="min-w-full text-sm md:text-base border border-gray-600">
            <thead>
              <tr className="bg-gray-700 text-left text-white">
                <th className="px-4 py-3 font-semibold">NOMOR</th>
                <th className="px-4 py-3 font-semibold">JENIS INFORMASI</th>
                <th className="px-4 py-3 font-semibold">TAHUN</th>
                <th className="px-4 py-3 font-semibold">TAUTAN</th>
              </tr>
            </thead>
            <tbody>
              {ipkd2023Data.map((item, index) => (
                <tr
                  key={index}
                ...
                >
                  ...
                  <td className="px-4 py-2 border border-gray-600 text-gray-300">2023</td>
