  ...
  return (
    <PageWithSidebar>
      ...
      >
        ...
        >
          INDEKS PENGELOLAAN KEUANGAN DAERAH TAHUN 2020
        </motion.h1>

        {/* Tabel Data IPKD 2020 */}
            ...
            <tbody>
              {ipkd2020Data.map((item, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-2 border border-gray-600 text-gray-300">2020</td>
