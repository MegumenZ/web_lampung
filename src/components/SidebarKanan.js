...
function SidebarKanan() {
  ...
  return (
    <aside className="w-full md:w-96 bg-[#f9f9f9] dark:bg-gray-800 p-6 rounded-2xl shadow-xl flex flex-col space-y-8 text-base transition-all duration-300 animate-fade-in">
      {/* Pencarian */}
